...
<?php
  ...
  $usr_data = mysqli_fetch_assoc($run_user_tbl);
	...
	$edit_table .= "<tr><td><b>First Name:</b></td><td>{$result['fname']}</td><td><input type=text name='fname'></td></tr>";
	$edit_table .= "<tr><td><b>Last Name:</b></td><td>{$result['lname']}</td><td><input type=text name='lname'></td></tr>";
...
<?php
	...
	if(($role1 == 2) ||($role2 == 2) ||($role3 == 2)){
		echo "<br /><br /><a class='redir' href='../faculty-reviewer/index.php'>Change to Faculty Reviewer View</a><br /><br />";
	}
